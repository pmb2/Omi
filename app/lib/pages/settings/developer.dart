                    ...
                    child: Column(
                      children: [
                        ...
                        _buildExperimentalItem(
                          title: 'Always-on background capture',
                          description: 'Keep Omi listening and streaming in the background (uses foreground service).',
                          icon: FontAwesomeIcons.waveSquare,
                          value: provider.omiAlwaysOn,
                          onChanged: provider.onOmiAlwaysOnChanged,
                        ),
                      ],
                    ),
                  ),
